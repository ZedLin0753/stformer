...
class Model(nn.Module):
    def __init__(self, num_classes, num_joints, num_frames, num_persons, 
                 num_heads, num_channels, kernel_size, frame_stride=8, beta=8, use_pess=None, use_pest=None,
        ...
        self.part_pool1 = StaticGroupWeightPool()
        self.part_pool2 = StaticGroupWeightPool()
        self.part_pool3 = StaticGroupWeightPool()
        self.part_pool4 = StaticGroupWeightPool()
