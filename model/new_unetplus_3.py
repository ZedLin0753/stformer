...
class Model(nn.Module):
    def __init__(self, num_classes, num_joints, 
        ...
        #Decder Blocks
        self.de0_1 = TRANS_Block(in_channels=64, out_channels=64, qkv_dim=64, num_frames=num_frames, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_2 = TRANS_Block(in_channels=128, out_channels=128, qkv_dim=64, num_frames=num_frames, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_3 = TRANS_Block(in_channels=256, out_channels=256, qkv_dim=64, num_frames=num_frames, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_4 = TRANS_Block(in_channels=512, out_channels=512, qkv_dim=64, num_frames=num_frames, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        
        self.decoders0.append(self.de0_1)

        self.decoders1.append(self.de0_2)
        self.decoders1.append(self.de0_1)

        self.decoders2.append(self.de0_3)
        self.decoders2.append(self.de0_2)
        self.decoders2.append(self.de0_1)

        self.decoders3.append(self.de0_4)
        self.decoders3.append(self.de0_3)
        self.decoders3.append(self.de0_2)
        self.decoders3.append(self.de0_1)
    ...
    def forward(self, x):
        ...
        #Decoding
        #decoders1
        up1_0 = self.upsample(x1_0)             #(32, 128, 120, 25)
        up1_0 = self.up1(up1_0)                 #(32, 64, 120, 25)
        x0_1 = self.de0_1(x0_0 + up1_0)         #(32, 64, 120, 25)

        #decoders2
        up2_0 = self.upsample(x2_0)             #(32, 256, 60, 25)
        up2_0 = self.up2(up2_0)                 #(32, 128, 60, 25)
        x1_1 = self.de0_2(x1_0 + up2_0)         #(32, 128, 60, 25)

        up1_1 = self.upsample(x1_1)             #(32, 128, 120, 25)
        up1_1 = self.up1(up1_1)                 #(32, 64, 120, 25)               
        x0_2 = self.de0_1((x0_1 + up1_1))       #(32, 64, 120, 25)

        #decoders3
        up3_0 = self.upsample(x3_0)             #(32, 512, 30, 25)
        up3_0 = self.up3(up3_0)                 #(32, 256, 30, 25)
        x2_1 = self.de0_3((x2_0 + up3_0))       #(32, 256, 30, 25)
       
        up2_1 = self.upsample(x2_1)             #(32, 256, 60, 25)
        up2_1 = self.up2(up2_1)                 #(32, 128, 60, 25)
        x1_2 = self.de0_2(x1_1 + up2_1)         #(32, 128, 60, 25)
        
        up1_2 = self.upsample(x1_2)             #(32, 128, 120, 25)
        up1_2 = self.up1(up1_2)                 #(32, 64, 120, 25)
        x0_3 = self.de0_1(x0_2 + up1_2)         #(32, 64, 120, 25)

        #decoders4
        up4_0 = self.up4(x4_0)                  #(32, 512, 15, 25)
        x3_1 = self.de0_4((x3_0 + up4_0))       #(32, 512, 15, 25)
        
        up3_1 = self.upsample(x3_1)             #(32, 512, 30, 25)
        up3_1 = self.up3(up3_1)                 #(32, 256, 30, 25)
        x2_2 = self.de0_3((x2_1 + up3_1))       #(32, 256, 30, 25)
        
        up2_2 = self.upsample(x2_2)             #(32, 256, 60, 25)
        up2_2 = self.up2(up2_2)                 #(32, 128, 60, 25)
        x1_3 = self.de0_2((x1_2 + up2_2))        #(32, 128, 60, 25)
       
        up1_3 = self.upsample(x1_3)             #(32, 128, 120, 25)
        up1_3 = self.up1(up1_3)                 #(32, 64, 120, 25)
        x0_4 = self.de0_1((x0_3 + up1_3))       #(32, 64, 120, 25)

        #Final Layer

        #final_1
        final_1 = x0_1.view(N, M, self.out_channels, -1)
        final_1 = final_1.permute(0, 1, 3, 2).contiguous().view(N, -1, self.out_channels, 1)
        final_1 = self.drop_out2d(final_1)
        final_1 = final_1.mean(3).mean(1)
        final_1 = self.drop_out(final_1)

        final_1 = self.fc(final_1)

        #final_2
        final_2 = x0_2.view(N, M, self.out_channels, -1)
        final_2 = final_2.permute(0, 1, 3, 2).contiguous().view(N, -1, self.out_channels, 1)
        final_2 = self.drop_out2d(final_2)
        final_2 = final_2.mean(3).mean(1)
        final_2 = self.drop_out(final_2)

        final_2 = self.fc(final_2)

        #final_3
        final_3 = x0_3.view(N, M, self.out_channels, -1)
        final_3 = final_3.permute(0, 1, 3, 2).contiguous().view(N, -1, self.out_channels, 1)
        final_3 = self.drop_out2d(final_3)
        final_3 = final_3.mean(3).mean(1)
        final_3 = self.drop_out(final_3)

        final_3 = self.fc(final_3)
