...
class Model(nn.Module):
    def __init__(self, num_classes, num_joints, num_frames, num_persons, 
        ...
        #Encoder Blocks
        self.en0_0 = STA_Block(in_channels=64, out_channels=64, qkv_dim=32, num_frames=120, num_joints=25,num_heads=num_heads, kernel_size=kernel_size)
        self.en1_0 = STA_Block(in_channels=64, out_channels=128, qkv_dim=32, num_frames=120, num_joints=25,num_heads=num_heads, kernel_size=kernel_size)
        self.en2_0 = STA_Block(in_channels=128, out_channels=128, qkv_dim=64, num_frames=60, num_joints=6, num_heads=num_heads, kernel_size=kernel_size)
        self.en3_0 = STA_Block(in_channels=128, out_channels=256, qkv_dim=64, num_frames=60, num_joints=6, num_heads=num_heads, kernel_size=kernel_size)
       #self.en4_0 = STA_Block(in_channels=256, out_channels=256, qkv_dim=64, num_frames=30, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        ...
        #Decder Blocks
        self.de0_0 = STA_Block(in_channels=128, out_channels=128, qkv_dim=64, num_frames=120, num_joints=25,num_heads=num_heads, kernel_size=kernel_size)
        self.de0_1 = STA_Block(in_channels=128, out_channels=128, qkv_dim=64, num_frames=120, num_joints=25,num_heads=num_heads, kernel_size=kernel_size)
        self.de0_2 = STA_Block(in_channels=128, out_channels=128, qkv_dim=64, num_frames=60, num_joints=6,num_heads=num_heads, kernel_size=kernel_size)
        self.de0_3 = STA_Block(in_channels=256, out_channels=128, qkv_dim=64, num_frames=60, num_joints=6,num_heads=num_heads, kernel_size=kernel_size)
    ...
    def forward(self, x):
        ...
        down1 = self.s_down1(down1)   #(128, 128, 60, 6)
