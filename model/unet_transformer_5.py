...
from .ST_Block import SpatioTemporalTransformerBlock
...
class Model(nn.Module):
    def __init__(self, num_classes, num_joints, 
        ...
        #Encoder Blocks
        self.en0_0 = SpatioTemporalTransformerBlock(in_channels=32, out_channels=64, qkv_dim=64, num_frames=120, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.en1_0 = SpatioTemporalTransformerBlock(in_channels=64, out_channels=128, qkv_dim=64, num_frames=60, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.en2_0 = SpatioTemporalTransformerBlock(in_channels=128, out_channels=256, qkv_dim=64, num_frames=30, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.en3_0 = SpatioTemporalTransformerBlock(in_channels=256, out_channels=512, qkv_dim=64, num_frames=15, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.en4_0 = SpatioTemporalTransformerBlock(in_channels=512, out_channels=1024, qkv_dim=64, num_frames=15, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        
        

        #Decder Blocks
        self.de0_1 = SpatioTemporalTransformerBlock(in_channels=128, out_channels=64, qkv_dim=64, num_frames=120, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_2 = SpatioTemporalTransformerBlock(in_channels=256, out_channels=128, qkv_dim=64, num_frames=60, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_3 = SpatioTemporalTransformerBlock(in_channels=512, out_channels=256, qkv_dim=64, num_frames=30, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_4 = SpatioTemporalTransformerBlock(in_channels=1024, out_channels=512, qkv_dim=64, num_frames=15, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
    ...
    def forward(self, x):
        ...
        #Position Embedding
        #x = self.pes(x) +89	 x if self.use_pes else x  #(32, 32, 120, 25)
