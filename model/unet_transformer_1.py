...
class Model(nn.Module):
    def __init__(self, num_classes, num_joints, 
        ...
        #Decder Blocks
        self.de0_1 = TRANS_Block(in_channels=64, out_channels=64, qkv_dim=64, num_frames=15, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_2 = TRANS_Block(in_channels=128, out_channels=128, qkv_dim=64, num_frames=30, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_3 = TRANS_Block(in_channels=256, out_channels=256, qkv_dim=64, num_frames=60, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
        self.de0_4 = TRANS_Block(in_channels=512, out_channels=512, qkv_dim=64, num_frames=120, num_joints=num_joints, num_heads=num_heads, kernel_size=kernel_size)
